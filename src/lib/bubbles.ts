import narrator from "@/assets/bubbles/BPP-Narrator.png.asset.json";
import classic from "@/assets/bubbles/BPP-Classic.png.asset.json";
import thinking from "@/assets/bubbles/BPP-Thinking.png.asset.json";
import dark from "@/assets/bubbles/BPP-Dark.png.asset.json";
import angry from "@/assets/bubbles/BPP-Angry.png.asset.json";
...
import exclamation from "@/assets/bubbles/BPP-Exclamation.png.asset.json";
...
export const BUBBLES: BubbleStyle[] = [
  ...
  { id: "bpp-narrator", label: "BPP · Narrateur", url: narrator.url, darkText: true, inset: { x: 12, yTop: 22, yBottom: 22 } },
  { id: "bpp-classic", label: "BPP · Classique", url: classic.url, inset: { x: 10, yTop: 18, yBottom: 26 } },
  { id: "bpp-thinking", label: "BPP · Pensée", url: thinking.url, inset: { x: 20, yTop: 22, yBottom: 30 } },
  { id: "bpp-dark", label: "BPP · Sombre", url: dark.url, darkText: true, inset: { x: 18, yTop: 26, yBottom: 26 } },
  { id: "bpp-angry", label: "BPP · Colère", url: angry.url, darkText: true, inset: { x: 12, yTop: 18, yBottom: 18 } },
  ...
  { id: "bpp-exclamation", label: "BPP · Exclamation", url: exclamation.url, inset: { x: 16, yTop: 24, yBottom: 26 } },
];
